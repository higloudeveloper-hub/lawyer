...
export const content = {
  es: {
    ...
    hero: {
      ...
      stats: [
        { value: 15000, prefix: "+", suffix: "", label: "Clientes conectados" },
  ...
  en: {
    ...
    hero: {
      ...
      stats: [
        { value: 15000, prefix: "+", suffix: "", label: "Clients connected" },
        { value: 2500, prefix: "+", suffix: "", label: "Active lawyers" },
        { value: 98, prefix: "", suffix: "%", label: "Satisfaction" },
        { value: 20, prefix: "", suffix: "+", label: "Practice areas" },
      ],
